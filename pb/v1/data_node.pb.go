...
func (c *dataNodeClient) Write(ctx context.Context, in *WriteInfo, opts ...grpc.CallOption) (*WriteResponse, error) {
	...
	err := grpc.Invoke(ctx, "/loggrebutterfly.DataNode/Write", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataNodeClient) Read(ctx context.Context, in *ReadInfo, opts ...grpc.CallOption) (DataNode_ReadClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DataNode_serviceDesc.Streams[0], c.cc, "/loggrebutterfly.DataNode/Read", opts...)
	if err != nil {
		return nil, err
	}
...
func _DataNode_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loggrebutterfly.DataNode/Write",
	}
...
var fileDescriptor0 = []byte{
	...
	0x38, 0x83, 0xc0, 0x6c, 0x25, 0x15, 0x88, 0xbc, 0x4b, 0x62, 0x49, 0x22, 0x6e, 0x63, 0x8d, 0x26,
	0x33, 0x72, 0x71, 0x80, 0x94, 0xf8, 0xe5, 0xa7, 0xa4, 0x0a, 0xb9, 0x72, 0xb1, 0x82, 0xed, 0x10,
	0x92, 0xd2, 0x43, 0x73, 0xa5, 0x1e, 0xdc, 0x89, 0x52, 0x72, 0xd8, 0xe5, 0xe0, 0xee, 0x62, 0x10,
	0x72, 0xe0, 0x62, 0x01, 0xd9, 0x2c, 0x24, 0x89, 0xa1, 0x12, 0xe6, 0x60, 0x29, 0xec, 0x52, 0x20,
	0x87, 0x28, 0x31, 0x18, 0x30, 0x26, 0xb1, 0x81, 0xc3, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0xfd, 0x0b, 0x40, 0x21, 0x3e, 0x01, 0x00, 0x00,
}
